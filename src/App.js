                ...
                <div className="container">
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <div className="card-text"> {(this.state.isProcessing) ?
                                    '...........'
                                    : this.state.ocrText.length === 0 ? "No Valid Text Found / Upload Image to Parse Text From Image" : this.state.ocrText }</div>
                            </div>
                        </div>
